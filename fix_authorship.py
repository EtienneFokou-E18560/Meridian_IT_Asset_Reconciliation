...
def render_control_matrix() -> None:
    ...
    d.text((48, 42), "Meridian Data Services — ITAM-001 Appendix A Control Matrix", font=title_f, fill=(52, 42, 36))
...
def rebuild_policy_pdf() -> None:
    ...
    story.append(Paragraph("Meridian Data Services | Policy ITAM-001 | Version 3.3 | Effective 2026-01-01", small))
