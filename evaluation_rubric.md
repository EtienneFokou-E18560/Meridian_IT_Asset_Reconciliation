...
Rev 2.26: Clarify C11 Certification worksheet sign-off format (Name/Signature/Date columns); lighten C5 wording (lead with populated Evidence Source; ledger-consistency as subordinate fact). Evidence Source rewritten without stock opener pool; Dashboard/LR keep formulas + OOXML caches. Rev 2.24: Materialize Dashboard breakout counts/book values (and LR control totals) as typed literals so oracle/judge readers that ignore formula caches still see populated tables. Rev 2.23: Fit platform 60-criterion cap while keeping the quality-review “excellent” atomic splits; restore C7–C9 expected values; restore capital-gap Critical blocker; drop Critical-blocker definition, dashboard-by-location, RN-0132-accepted negative, and false-ledger-absence negative to fit. Rev 2.22: Remove golden-only EX-0001/$85; atomic Missing/transfer/custody splits; raise custody weight; drop serial-mismatch double-count.
...
5. For reviewed assets, the corrected asset register populates a non-blank evidence source for each reviewed asset. That evidence text does not claim there is no FA/ledger row for an asset tag that appears on the fixed-asset ledger extract; for MD-00130, MD-00131, and MD-00132 it may note ledger absence (under-threshold vs capital-qualifying distinction addressed in ledger reconciliation / RN-0132 / capital-gap criteria). | weight: 3
...
11. The Certification worksheet includes sign-off rows for the IT Operations Manager, Finance Controller, HR Operations Lead, and Internal Auditor, each with Name, Signature, and Date columns. | weight: 4
